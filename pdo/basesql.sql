...
--
-- Client: 127.0.0.1
-- Généré le: Lun 06 Octobre 2014 à 11:22
-- Version du serveur: 5.1.33-community
...
--
CREATE DATABASE IF NOT EXISTS `basesql` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `basesql`;
...
DROP TABLE IF EXISTS `ing_pro_cpc`;
